...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $p = htmlspecialchars($_POST["pays"]);
    $v = htmlspecialchars($_POST["ville"]);
    $t = htmlspecialchars($_POST["tel"]);
    $f = htmlspecialchars($_POST["formation"]);
    $c = htmlspecialchars($_POST["check"]);
    $message = htmlspecialchars($_POST["message"]);

    // Adresse email où vous souhaitez recevoir les messages (votre adresse Gmail)
    $destinataire = "contactiredi@gmail.com";
